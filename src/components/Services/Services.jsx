  ...
  const services = [
    {
      ...
      description: 'Custom metal fabrication services for industrial and commercial applications with precision and quality.',
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Professional welding solutions including MIG, TIG, and arc welding for various materials and projects.',
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: 'Custom Design',
      description: 'Tailored design solutions to meet your specific requirements, from concept to completion.',
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Comprehensive industrial fabrication solutions for manufacturing and construction sectors.',
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'High-quality powder coating services for durable, attractive, and long-lasting finishes.',
    },
  ];
